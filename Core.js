...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    Konichiwa ${pushname} dear 👋. I am/انا العزيز ${global.BotName}, a bot developed by: Elgazar to take your WhatsApp usage into next level/روبوت تم تطويره بواسطة: االزعيم غون للانتقال باستخدام واتساب إلى المستوى التالي.
 ...
 case 'dare':
    ...
    if (isBanChat) return reply(mess.bangc)
         ...
         "breakup with your best friend for 5hrs without telling him/her that its a dare",
          ...
          "كيس your mommy or papa and say i love you😌",
...
case 'truth':
    ...
    if (isBanChat) return reply(mess.bangc)
                 ...
                 "When is the last time you made someone else كيري",
...
انا *◤𝘌𝘓𝘡3𝘌𝘔🎭𝘎𝘖𝘕◢*, 
تم تطويره بواسطة الزعــيم غـون*.

♠️ لا تنسي تكتب هذه قبل كل امر:  ${prefix}
*البداية الخاصه بي🙂*

*ســــلاماً عليكم ورحمة الله وبركاته❤*
*اهـلاً وسـهلاً بـكم فـ بـوت: الزعـيم غـون✨*
*هـذا الـبوت تـم صـنعه للفـائده فـقط! لاغير ولـيس للخراب او الاشياء خارج مجتمعنا الاسلامي🙏*
*وصـف عـن الحياة": " في هذه الحياة ستتعلم كل شيءٍ وحدك 
إلا القسوة سيقوم شخص آخر بتعليمها لك .!*

*هـنا ينتهي عملي الان! استمتعو بالبوت🤗*
...
⧉ اترك سبب ذاهبك
 ...
 ⋄═──═◞🖤 قائمه شكر المطور 🖤◟━──━⋄
🍁 اهلا بك في بوت الزعــيم غـون نشكر الله علي هذا العمل الرائع
...
`
    ...
    {buttonId: `-nsfw`, buttonText: {displayText: 'صانع البوت: غـون '}, type: 1}
...
case '':
 ...
 const needhelpmenu = `مرحبا بك في بوت الزعيم غـون لظهور قائمه الاوامر اكتب -الاوامر او اضغط علي القائمه *${prefix}*.`
...
const txt = ` غـون هنا ياحب☺️/ للتواصل معايا: https://api.whatsapp.com/send?phone=+201146121794 / `
const mikuarray= [
